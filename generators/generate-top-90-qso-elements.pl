...
# Usage:
# ./generate-top-90-qso-elements.pl > top-90-qso-elements.txt
#
# Set $repeat, $top_x_words, and $num_random_words as appropriate

open my $in, "<", "data/top-90-qso-elements.csv";
my @lines = <$in>;
close $in;
...
my $multiplier = 7; # 14 for standard speeds - 7 for speed racing
