...
# Usage:
# ./generate-top-180-qso-elements.pl > top-180-qso-elements.txt
#
# Set $repeat, $top_x_words, and $num_random_words as appropriate

open my $in, "<", "data/top-180-qso-elements.csv";
my @lines = <$in>;
close $in;
...
my $multiplier = 4; # 6 for standard speeds - 4 for speed racing
my $num_random_qso_elements = scalar(@qso_elements)*4;
