...
# Usage: ./generate-licw-beginners-carousel1a.pl
#
...
sub create_lesson {
    ...
    my $write_file_name = "licw-beginners-carousel-1-lesson-${lesson_num_in_filename}d.txt";
...
sub create_lesson2 {
    ...
    my $lesson_num_in_filename = $lesson_num + 1;
    my $write_file_name = "licw-beginners-carousel-1-lesson-${lesson_num_in_filename}" . (chr(ord('d')+$num_in_each_rep-1)). ".txt";
    open(my $WRITE_FH2, '>', $write_file_name) or die $!;
